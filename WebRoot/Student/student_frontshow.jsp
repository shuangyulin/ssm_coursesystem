...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Student/frontlist">学生信息信息</a></li>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">登陆密码:</div>
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=student.getBirthday()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">政治面貌:</div>
		<div class="col-md-10 col-xs-6"><%=student.getZzmm()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">所在班级:</div>
		<div class="col-md-10 col-xs-6"><%=student.getClassName()%></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><img class="img-responsive" src="<%=basePath %><%=student.getPhoto() %>"  border="0px"/></div>
	</div>
	<div class="row bottom15"> 
