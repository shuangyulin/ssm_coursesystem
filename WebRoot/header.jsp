    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Kejian/frontlist">课件信息</a></li>
                <li><a href="<%=basePath %>Chapter/frontlist">章信息</a></li>
                <li><a href="<%=basePath %>Video/frontlist">视频信息</a></li>
                <li><a href="<%=basePath %>Exercise/frontlist">习题信息</a></li>
                <li><a href="<%=basePath %>Question/frontlist">在线问答</a></li>
                <li><a href="<%=basePath %>HomeworkTask/frontlist">作业任务</a></li>
                <li><a href="<%=basePath %>HomeworkUpload/frontlist">上传的作业</a></li>
