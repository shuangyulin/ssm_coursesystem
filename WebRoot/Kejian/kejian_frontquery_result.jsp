		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#kejianListPanel" aria-controls="kejianListPanel" role="tab" data-toggle="tab">课件信息列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Kejian/kejian_frontAdd.jsp" style="display:none;">添加课件信息</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>记录编号</td><td>课件标题</td><td>文件路径</td><td>添加时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<kejianList.size();i++) {
					    	            		...
					    	            		Kejian kejian = kejianList.get(i); //获取到课件信息对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
 											<td><%=kejian.getId() %></td>
 											<td><%=kejian.getTitle() %></td>
 											<td><%=kejian.getPath() %></td>
 											<td><%=kejian.getAddTime() %></td>
 											<td>
 												<a href="<%=basePath  %>Kejian/<%=kejian.getId() %>/frontshow"><i class="fa fa-info"></i>&nbsp;查看</a>&nbsp;
 												<a href="#" onclick="kejianEdit('<%=kejian.getId() %>');" style="display:none;"><i class="fa fa-pencil fa-fw"></i>编辑</a>&nbsp;
 												<a href="#" onclick="kejianDelete('<%=kejian.getId() %>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;课件信息信息编辑</h4>
      </div>
